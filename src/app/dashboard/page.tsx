...
// import ExpiredStock from '../ExpiredStock/page';
...
//   const fetchItem = async (itemId: string): Promise<string> => {
//     try {
...
//             const itemName = await fetchItem(inventory.itemId);
//             return {
//               ...inventory,
//               itemName,
//               expiredQuantity: expiredStockMap.get(inventory.itemId) || 0, // Get expired stock
//             };
//           })
//         );
...
//                   <td className={inv.expiredQuantity && inv.expiredQuantity > 0 ? 'text-red-500 font-bold' : ''}>
